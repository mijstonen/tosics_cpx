# This file is to test replacement of CPX-preprocess_hash_compile.sh with a custom script
#  by defining environment variable CPX_HASH_COMPILE.
#########################################################################################
...
LINK_LIBRARIES_OPTIONS="-lstdc++fs -lpthread -ldl -lutil"
...
echo "My alternative hash compile script to test 'ENV_CPX_HASH_COMPILE'"
